...
void	drawGraph(const std::vector<double> *time, const std::vector<double> *data, std::string nameGraph, bool show, int lineWidth)
{
	Plot plot;
	plot.legend()
        .atOutsideBottom()
 ...
 * @param lineWidth толщина линии
 */
void	drawGraph(const std::vector<double> *time, const std::vector<double> *data, Plot *plot, std::string nameGraph, bool show, std::string palette, int lineWidth)
{
 ...
 * @param lineWidth толщина линии
 */
void	drawLine(const std::vector<double> *time, const double *data, Plot *plot, std::string nameGraph, bool show, std::string palette, int lineWidth)
{
	(*plot).legend()
        .atOutsideBottom()
        .displayHorizontal()
